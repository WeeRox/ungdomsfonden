...
<html lang="sv">
  <head>
    ...
    <script src="/js/google-plus.js"></script>
  ...
  <body>
    ...
    <div id="share">
      <a class="share-button facebook">
          <img class="svg" src="/img/icons/facebook.svg"/>
      </a>
      <a class="share-button twitter">
          <img class="svg" src="/img/icons/twitter.svg"/>
      </a>
      <a class="share-button google-plus">
          <img class="svg" src="/img/icons/google-plus.svg"/>
      </a>
      <a class="share-button linkedin">
          <img class="svg" src="/img/icons/linkedin.svg"/>
      </a>
    </div>
    <div class="clear"></div>
  </body>
